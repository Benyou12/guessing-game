...
namespace PolyPaint.Utils.Transitions
{
    /// <summary>
    /// Logique d'interaction pour TransitionPage.xaml
    /// </summary>
    public partial class TransitionPage : UserControl
    {
        ...
        public static readonly DependencyProperty TransitionTypeProperty = DependencyProperty.Register("TransitionType",
            ...
            typeof(TransitionPage), new PropertyMetadata(TransitionType.SlideAndFade));
